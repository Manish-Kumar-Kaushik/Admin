...
export default function ConnectorDetail() {
  ...
  return (
    <div className="w-full h-full bg-slate-50 font-sans p-2 sm:p-4 lg:p-6 overflow-y-auto overflow-x-hidden">
      <div className="w-full max-w-none mx-auto space-y-6 px-2 sm:px-4 lg:px-6">
        ...
        {/* Tabs */}
        <div className="border-b border-slate-200 flex gap-6 overflow-x-auto whitespace-nowrap pb-1">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <Card className="bg-white border-slate-200 rounded-xl shadow-sm p-5 flex flex-col">
            ...
            <div className="flex flex-col lg:flex-row items-center justify-between h-full px-0 lg:px-4 gap-6 lg:gap-0">
              <div className="flex flex-col gap-3.5 w-full lg:w-[45%] pl-0 lg:pl-2">
              ...
              {/* Donut Chart */}
              <div className="w-full lg:w-[55%] flex flex-col sm:flex-row items-center justify-center gap-6">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-12 gap-6 pb-8">
          ...
          {/* API Endpoints */}
          <Card className="bg-white border-slate-200 rounded-xl shadow-sm p-0 flex flex-col xl:col-span-5">
          ...
          {/* Recent Errors */}
          <Card className="bg-white border-slate-200 rounded-xl shadow-sm p-0 flex flex-col xl:col-span-4">
            <div className="p-5 border-b border-slate-100 flex items-center justify-between">
            ...
            <div className="w-full overflow-x-auto">
              <Table>
                <TableHeader className="bg-slate-50/50">
                  <TableRow className="hover:bg-transparent">
                    <TableHead className="text-[11px] font-bold text-slate-500 uppercase h-10 whitespace-nowrap">Time</TableHead>
                    <TableHead className="text-[11px] font-bold text-slate-500 uppercase h-10 whitespace-nowrap">Error</TableHead>
                    <TableHead className="text-[11px] font-bold text-slate-500 uppercase h-10 whitespace-nowrap">Count</TableHead>
                    <TableHead className="text-[11px] font-bold text-slate-500 uppercase h-10 whitespace-nowrap">Last Occurred</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
                  {RECENT_ERRORS.map((row, i) => (
                    <TableRow key={i}>
                      <TableCell className="py-3 text-[12px] text-slate-600 whitespace-nowrap">{row.time}</TableCell>
                      <TableCell className="py-3 text-[12px] font-semibold text-slate-900 flex items-center gap-2 whitespace-nowrap">
                        <span className={`w-1.5 h-1.5 rounded-full ${row.color}`}></span>
                        {row.error}
                      </TableCell>
                      <TableCell className="py-3 text-[12px] font-medium text-slate-900 whitespace-nowrap">{row.count}</TableCell>
                      <TableCell className="py-3 text-[12px] text-slate-500 whitespace-nowrap">{row.lastOccurred}</TableCell>
                    </TableRow>
                  ))}
                </TableBody>
              </Table>
          ...
          <Card className="bg-white border-slate-200 rounded-xl shadow-sm p-5 flex flex-col xl:col-span-3">
