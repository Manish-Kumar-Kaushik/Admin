...
export default function AiVerdictReview() {
  ...
  return (
    <div className="w-full h-full bg-slate-50 font-sans overflow-y-auto">
      ...
      */}
      <div className="p-4 sm:p-6 lg:p-8 w-full max-w-full mx-auto space-y-6 overflow-x-hidden">
        ...
        <div className="flex flex-col lg:flex-row lg:items-start justify-between gap-4">
          <div>
            <div className="flex flex-wrap items-center gap-3">
              <h1 className="text-[24px] sm:text-[28px] font-bold text-slate-950 tracking-tight">AI Verdict Review</h1>
              <Badge className="bg-indigo-50 text-indigo-700 hover:bg-indigo-100 border-indigo-200 font-semibold px-2.5 py-0.5 mt-1 shrink-0">
                AI Verdict
              </Badge>
            </div>
            <p className="text-[14px] sm:text-[15px] text-slate-500 mt-1 break-words">Review the AI verdict, score, and reasoning before approving.</p>
          </div>

          <div className="flex flex-wrap items-center gap-2 sm:gap-3 w-full lg:w-auto">
            <button className="flex-1 sm:flex-none flex items-center justify-center gap-2 h-10 px-3 sm:px-4 bg-white border border-slate-200 rounded-lg text-[13px] sm:text-sm font-bold text-slate-700 hover:bg-slate-50 transition-colors shadow-sm whitespace-nowrap">
              <User className="w-4 h-4 text-slate-400 shrink-0" />
              Send to Human
            </button>
            <button className="flex-1 sm:flex-none flex items-center justify-center gap-2 h-10 px-3 sm:px-4 bg-emerald-50 border border-emerald-200 rounded-lg text-[13px] sm:text-sm font-bold text-emerald-700 hover:bg-emerald-100 transition-colors shadow-sm whitespace-nowrap">
              <CheckCircle2 className="w-4 h-4 shrink-0" />
              Approve
            </button>
            <button className="flex-1 sm:flex-none flex items-center justify-center gap-2 h-10 px-3 sm:px-4 bg-rose-50 border border-rose-200 rounded-lg text-[13px] sm:text-sm font-bold text-rose-700 hover:bg-rose-100 transition-colors shadow-sm whitespace-nowrap">
        ...
        <div className="flex flex-col xl:flex-row items-stretch gap-6">
          ...
          <Card className="bg-white border-slate-200 rounded-xl shadow-sm p-4 sm:p-6 flex flex-col lg:flex-row items-stretch gap-6 lg:gap-8 w-full xl:w-[72%]">

            {/* Left: Product Info */}
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 w-full lg:w-[55%]">
            ...
            <div className="w-full lg:w-[1px] h-[1px] lg:h-auto bg-slate-200 shrink-0 my-2 lg:my-0"></div>

            {/* Middle: AI Verdict & Score */}
            <div className="w-full lg:w-[45%] flex flex-col justify-between gap-4 lg:gap-0">
              <div>
          ...
          {/* Right: Queue Details */}
          <Card className="bg-white border-slate-200 rounded-xl shadow-sm p-4 sm:p-6 w-full xl:w-[28%] flex flex-col">
