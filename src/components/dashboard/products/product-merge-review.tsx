...
function ProductCard({
  ...
  return (
    <Card className="flex-1 p-6 bg-white border border-slate-200 rounded-xl shadow-sm relative overflow-hidden flex flex-col">
      ...
      <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 mt-6 flex-1">
        <div className="w-24 sm:w-[120px] shrink-0 mx-auto sm:mx-0">
        ...
        <div className="flex-1 flex flex-col">
          <h2 className="text-center sm:text-left text-sm font-bold text-slate-900 leading-snug mb-3 sm:pr-4">{title}</h2>
...
export default function ProductMergeReview() {
  ...
  return (
    <div className="flex-1 bg-slate-50 flex flex-col relative w-full overflow-x-hidden" style={{ fontFamily: "Inter, sans-serif" }}>
      
      {/* ══ HEADER ══ */}
      <div className="px-8 pt-8 pb-2 flex items-start sm:items-center justify-between flex-col sm:flex-row gap-4">
        <div>
      ...
      <div className="w-full overflow-x-hidden pb-8">
        <div className="px-4 sm:px-6 lg:px-8 pt-4 pb-4 flex flex-col gap-6 w-full max-w-full">
        
        {/* ══ TOP ROW: PRODUCTS & SIMILARITY ══ */}
        <div className="flex flex-col xl:flex-row gap-6 h-auto xl:h-[340px]">
          <ProductCard
            label="Product A"
          ...
          <Card className="w-full xl:w-[300px] shrink-0 p-6 bg-white border border-slate-200 rounded-xl shadow-sm flex flex-col items-center justify-center">
            ...
            <div className="flex-1 flex flex-col gap-0.5">
              {[
                ...
                <div key={i} className="flex items-center justify-between py-2 border-b border-slate-100 last:border-0 hover:bg-slate-50/50 rounded-md px-2 -mx-2 transition-colors">
                  <div className="flex items-center gap-1.5 sm:gap-2.5 w-[35%]">
                    <item.icon className="w-3.5 h-3.5 sm:w-4 sm:h-4 shrink-0 text-slate-500" />
                    <span className="text-[10px] sm:text-[12px] font-semibold text-slate-700 leading-tight">{item.label}</span>
                  </div>
                  <div className="w-[40%] sm:w-[45%] text-[10px] sm:text-[12px] font-bold text-slate-900 truncate pr-2 sm:pr-4">
                    {item.val}
                  </div>
                  <div className="w-[25%] sm:w-[20%] text-right">
                    <Badge variant="outline" className={cn("text-[9px] sm:text-[10px] font-bold px-1.5 sm:px-2 py-0 border-transparent rounded", item.bColor)}>
                      {item.badge}
                    </Badge>
                  </div>
                </div>
            ...
            <div className="w-full overflow-x-auto">
              <Table className="min-w-[500px]">
                ...
                <TableRow className="hover:bg-transparent border-slate-100 border-y">
                  <TableHead className="text-[9px] sm:text-[11px] font-bold text-slate-500 uppercase h-10 px-3 sm:px-6">Identifier Type</TableHead>
                  <TableHead className="text-[9px] sm:text-[11px] font-bold text-slate-500 uppercase h-10 px-3 sm:px-6">Product A</TableHead>
                  <TableHead className="text-[9px] sm:text-[11px] font-bold text-slate-500 uppercase h-10 px-3 sm:px-6">Product B</TableHead>
                  <TableHead className="text-[9px] sm:text-[11px] font-bold text-slate-500 uppercase h-10 text-right px-3 sm:px-6">Match</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
                {[
                  ...
                  <TableRow key={i} className="hover:bg-slate-50/80 border-slate-100">
                    <TableCell className="text-[10px] sm:text-[12px] font-semibold text-slate-700 py-2 sm:py-3.5 px-3 sm:px-6">{row.type}</TableCell>
                    <TableCell className="text-[10px] sm:text-[12px] font-mono font-bold text-slate-900 py-2 sm:py-3.5 px-3 sm:px-6">{row.a}</TableCell>
                    <TableCell className="text-[10px] sm:text-[12px] font-mono font-bold text-slate-900 py-2 sm:py-3.5 px-3 sm:px-6">{row.b}</TableCell>
                    <TableCell className="py-2 sm:py-3.5 text-right px-3 sm:px-6">
                      <div className="flex justify-end">
                        <div className="w-4 h-4 sm:w-5 sm:h-5 rounded-full bg-green-50 border border-green-200 flex items-center justify-center">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
          ...
          <Card className="bg-white border border-slate-200 rounded-xl shadow-sm p-6 flex flex-col">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-3 h-full mt-2">
              {[
        ...
        {/* ══ FOOTER ACTION BAR (Natural flow, no fixed bg) ══ */}
        <div className="pt-4 px-4 sm:px-8 flex flex-col sm:flex-row items-center sm:justify-between gap-4">
