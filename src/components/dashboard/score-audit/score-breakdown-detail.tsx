      ...
      <div className="flex-1 min-w-0">
        <div className="w-full px-3 sm:px-5 py-3">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-2 mb-3 sm:mb-1">
            <nav className="flex items-center flex-wrap gap-1 text-[12px]">
              <button
              ...
              <ChevronRight className="w-3 h-3 text-slate-400 shrink-0" />
              <span className="text-slate-500 whitespace-nowrap">Sony WH-1000XM5</span>
            </nav>
            ...
            <div className="hidden sm:flex items-center gap-2">
              <button
                onClick={() => router.push("/dashboard/audit")}
                className="flex justify-center items-center gap-1.5 h-8 px-3 text-[12px] font-medium bg-white border border-slate-200 rounded-lg text-slate-700 hover:bg-slate-50 shadow-sm transition-all"
              >
                <ArrowLeft className="w-3.5 h-3.5 shrink-0" />
                <span className="whitespace-nowrap">Back to Score Audit</span>
              </button>
              <button className="flex justify-center items-center gap-1.5 h-8 px-3 text-[12px] font-semibold bg-white border border-slate-200 rounded-lg text-slate-700 hover:bg-slate-50 shadow-sm transition-all">
          ...
          <div className="mb-4">
            ...
            {/* Mobile Actions */}
            <div className="flex sm:hidden flex-wrap items-center gap-2 w-full mt-3">
              <button
                onClick={() => router.push("/dashboard/audit")}
                className="flex flex-1 justify-center items-center gap-1.5 h-8 px-3 text-[12px] font-medium bg-white border border-slate-200 rounded-lg text-slate-700 hover:bg-slate-50 shadow-sm transition-all"
              >
                <ArrowLeft className="w-3.5 h-3.5 shrink-0" />
                <span className="whitespace-nowrap">Back to Score Audit</span>
              </button>
              <button className="flex flex-1 justify-center items-center gap-1.5 h-8 px-3 text-[12px] font-semibold bg-white border border-slate-200 rounded-lg text-slate-700 hover:bg-slate-50 shadow-sm transition-all">
                <Download className="w-3.5 h-3.5 shrink-0" />
                Export
                <ChevronDown className="w-3 h-3 text-slate-400 shrink-0" />
              </button>
