...
const users: User[] = [
  {
    ...
    priceAlerts: 5,
    receiptsUploaded: 3,
    lastActive: "May 20, 2024",
    lastActiveTime: "10:15 AM",
  ...
  },
  {
    ...
    priceAlerts: 1,
    receiptsUploaded: 0,
    lastActive: "May 19, 2024",
    lastActiveTime: "8:31 PM",
    createdDate: "May 19, 2024",
  },
  {
    id: "U-1048924",
  ...
  },
  {
    ...
    priceAlerts: 4,
    receiptsUploaded: 2,
    lastActive: "May 17, 2024",
    lastActiveTime: "8:45 PM",
...
function StatusBadge({ status }: { status: AccountStatus }) {
  ...
  return (
    <span
      className={`inline-flex items-center gap-1.5 rounded-md px-2.5 py-1 text-xs font-semibold ${s.badge}`}
    >
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-slate-500">
              View and manage users for support and account administration. We
          ...
          <div className="flex flex-col gap-4 px-4 sm:px-6 py-4 border-b border-slate-200 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
              ...
              <nav className="inline-flex items-center rounded-lg bg-white shadow-sm ring-1 ring-slate-200 overflow-hidden">
                ...
                <button className="flex h-8 w-8 items-center justify-center bg-[#4F46E5] text-sm font-semibold text-white">
                  1
                </button>
                <button className="flex h-8 w-8 items-center justify-center text-sm font-medium text-slate-600 hover:bg-slate-50 transition">
                  2
                </button>
                <button className="flex h-8 w-8 items-center justify-center text-sm font-medium text-slate-600 hover:bg-slate-50 transition">
                  3
                ...
                <button className="flex h-8 w-8 items-center justify-center text-sm text-slate-400">
                  ...
                </button>
                <button className="flex h-8 w-8 items-center justify-center text-sm font-medium text-slate-600 hover:bg-slate-50 transition">
                  1,285
              ...
              <tbody className="divide-y divide-slate-100">
                {users.map((user) => (
                  ...
                  >
                    ...
                    <td className="px-4 sm:px-6 py-4 text-sm text-slate-700 text-center">
                      {user.savedProducts}
                    </td>
                    <td className="px-4 sm:px-6 py-4 text-sm text-slate-700 text-center">
                      {user.priceAlerts}
